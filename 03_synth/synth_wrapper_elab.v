...
// Generated on: May 12 2025 12:46:56
...
module counter_4bit(clk, rst_n, sel, out);
  ...
  cla_4bit cla_4bit(.a (out), .b ({count_value[1], count_value[1],
...
module synth_wrapper(clk, rst_n, sel, count);
  ...
  wire UNCONNECTED3, UNCONNECTED4, UNCONNECTED5, UNCONNECTED6,
       UNCONNECTED7, \count_reg[0]_14 , \count_reg[1]_15 ,
       \count_reg[2]_16 ;
  wire \count_reg[3]_17 , n_6, sel_reg;
  ...
  bmux_1 mux_sel_reg_14_12(.ctl (n_6), .in_0 (sel), .in_1 (1'b0), .z
       (UNCONNECTED3));
  bmux mux_count_14_12(.ctl (n_6), .in_0 ({\count_reg[3]_17 ,
       \count_reg[2]_16 , \count_reg[1]_15 , \count_reg[0]_14 }), .in_1
       (4'b0000), .z ({UNCONNECTED7, UNCONNECTED6, UNCONNECTED5,
       UNCONNECTED4}));
  not g1 (n_6, rst_n);
  CDN_flop \count_reg[0] (.clk (clk), .d (\count_reg[0]_14 ), .sena
       (1'b1), .aclr (n_6), .apre (1'b0), .srl (1'b0), .srd (1'b0), .q
       (count[0]));
  CDN_flop \count_reg[1] (.clk (clk), .d (\count_reg[1]_15 ), .sena
       (1'b1), .aclr (n_6), .apre (1'b0), .srl (1'b0), .srd (1'b0), .q
       (count[1]));
  CDN_flop \count_reg[2] (.clk (clk), .d (\count_reg[2]_16 ), .sena
       (1'b1), .aclr (n_6), .apre (1'b0), .srl (1'b0), .srd (1'b0), .q
       (count[2]));
  CDN_flop \count_reg[3] (.clk (clk), .d (\count_reg[3]_17 ), .sena
       (1'b1), .aclr (n_6), .apre (1'b0), .srl (1'b0), .srd (1'b0), .q
       (count[3]));
